...
INSERT INTO library.library_user_info (ID, VERSION, CREATED_AT, UPDATED_AT, DATA_UPDATED_AT, USERNAME, EMAIL, RANK,
                                       CURRENT_SCORE, USER_AUTH_ID)
VALUES ('123e4567-e89b-12d3-a456-426614174000', 0, CURRENT_TIMESTAMP - INTERVAL '100 day', CURRENT_TIMESTAMP,
        CURRENT_TIMESTAMP - INTERVAL '100 day', 'USER1', 'sample.email1@gmail.com', 1, 5,
        '123e4567-e89b-12d3-a456-426614174000'),
       ('123e4567-e89b-12d3-a456-426614174001', 0, CURRENT_TIMESTAMP - INTERVAL '2 day', CURRENT_TIMESTAMP,
        CURRENT_TIMESTAMP, 'USER2', 'sample.email2@gmail.com', 0, 1, '123e4567-e89b-12d3-a456-426614174001'),
       ('123e4567-e89b-12d3-a456-426614174002', 0, CURRENT_TIMESTAMP - INTERVAL '2 day', CURRENT_TIMESTAMP,
        CURRENT_TIMESTAMP, 'USER_GOOGLE3', 'sample.email3@gmail.com', 0, 0, '123e4567-e89b-12d3-a456-426614174002');
