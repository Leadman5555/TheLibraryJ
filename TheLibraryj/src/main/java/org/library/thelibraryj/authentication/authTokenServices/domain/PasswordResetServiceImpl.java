...
class PasswordResetServiceImpl implements PasswordControl {
    ...
    public PasswordResetServiceImpl(AuthTokenRepository authTokenRepository, EmailService emailService, UserAuthService userAuthService, PasswordResetProperties passwordResetProperties, PasswordEncoder passwordEncoder) {
