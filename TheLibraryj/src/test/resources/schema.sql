...
CREATE TABLE library.library_user_info(id         UUID   NOT NULL,    version    BIGINT NOT NULL DEFAULT 0,created_at TIMESTAMP,updated_at TIMESTAMP,data_updated_at TIMESTAMP, username   VARCHAR(25) UNIQUE NOT NULL, email      VARCHAR(50) UNIQUE NOT NULL, rank       INTEGER NOT NULL DEFAULT 0, user_auth_id UUID NOT NULL, CONSTRAINT pk_library_user_info PRIMARY KEY (id));
DROP TABLE IF EXISTS library.library_user_auth;
CREATE TABLE  library.library_user_auth(id           UUID               NOT NULL,   version      BIGINT             NOT NULL DEFAULT 0,created_at   TIMESTAMP,updated_at   TIMESTAMP,password VARCHAR(200) NOT NULL,email        VARCHAR(50) UNIQUE NOT NULL,role         VARCHAR(5)      NOT NULL,is_enabled BOOLEAN NOT NULL DEFAULT false, is_google  BOOLEAN            NOT NULL,CONSTRAINT pk_library_user_auth PRIMARY KEY (id));
DROP TABLE IF EXISTS library.library_tokens;
CREATE TABLE library.library_tokens(id          UUID      NOT NULL,token       UUID      NOT NULL,for_user_id UUID      NOT NULL,version     BIGINT    NOT NULL DEFAULT 0,created_at  TIMESTAMP,updated_at  TIMESTAMP,expires_at  TIMESTAMP NOT NULL,is_used     BOOLEAN   NOT NULL DEFAULT false,CONSTRAINT pk_library_tokens PRIMARY KEY (id));
