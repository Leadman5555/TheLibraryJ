...
CREATE TABLE library.library_user_info(id         UUID   NOT NULL,    version    BIGINT NOT NULL DEFAULT 0,created_at TIMESTAMP,updated_at TIMESTAMP,  data_updated_at TIMESTAMP, username   VARCHAR(20) UNIQUE NOT NULL, email      VARCHAR(50) UNIQUE NOT NULL, rank       TINYINT NOT NULL DEFAULT 0, user_auth_id UUID NOT NULL, CONSTRAINT pk_library_user_info PRIMARY KEY (id));
